        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              A Computer Science Engineering student passionate about full-stack development. I focus on building modern, responsive web applications and consistently strive to deliver high-quality solutions in every project I take on.I'm always eager to learn and explore new technologies and tools to improve my skills and contribute to the tech community. My goal is to create impactful digital experiences that solve real-world problems and enhance user engagement.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1pdwEBWubCnfYmnLcH77OhxEi1uuyvUwo/view" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
