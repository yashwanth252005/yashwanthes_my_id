...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/yashwanthes616@gmail.com';
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Got a question? Send me a message, and I’ll get back to you shortly.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Have something to discuss or Got an idea? Let’s talk — I’m just a message away.
                </p>
              </div>
